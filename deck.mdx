...
In addition to complex states, state machines can also be used for modeling UI components (a button is just a tiny state machine).
...
## Top 3 things to avoid <br /> when writing reducer's code
----
